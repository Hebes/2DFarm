...
//    private void Awake()
//    {
//        inputInfo = InputManagerSystem.Instance.inputInfo;
//    }
...
//        {
//            InputManagerSystem.Instance.ChangeBtn(BTN_TYPE.UP);
//        });
//        btnDown.onClick.AddListener(() =>
//        {
//            InputManagerSystem.Instance.ChangeBtn(BTN_TYPE.DOWN);
//        });
//        btnLeft.onClick.AddListener(() =>
//        {
//            InputManagerSystem.Instance.ChangeBtn(BTN_TYPE.LEFT);
//        });
//        btnRight.onClick.AddListener(() =>
//        {
//            InputManagerSystem.Instance.ChangeBtn(BTN_TYPE.RIGHT);
//        });
//        btnFire.onClick.AddListener(() =>
//        {
//            InputManagerSystem.Instance.ChangeBtn(BTN_TYPE.FIRE);
//        });
//        btnJump.onClick.AddListener(() =>
//        {
//            InputManagerSystem.Instance.ChangeBtn(BTN_TYPE.JUMP);
//        });
//    }
