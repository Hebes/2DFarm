...
namespace ACFrameworkCore
{
    ...
    //    FIELD_NAME = 0,//名称
    //    FIELD_TYPE = 1,//类型
    //    DATA_START_ROW = 3//开始行数
    //}

    public class ExcelChange2 : EditorWindow
    {
        /// <summary>
        /// 放置Excel文件的路径
        /// </summary>
        private static readonly string ExcelPath = $"{Application.dataPath}/Editor/Excels/";
        ...
        private static void CreateByte(string filePath, string[][] data)
        {
            ...
            using (FileStream fileStream = new FileStream(path, FileMode.Create))
            {
                ...
                {
                    for (int i = (int)RowType.BEGIN_INDEX; i < data.Length; ++i)
                    {
